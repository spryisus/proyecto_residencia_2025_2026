...
class DHLTrackingService {
  ...
  // Si es null, usará petición directa a DHL
  ...
  /// Constructor con opción de configurar URL del proxy
  DHLTrackingService({this.proxyUrl});
  ...
  Future<ShipmentTracking> trackShipment(String trackingNumber) async {
    ...
    // Si tenemos proxy configurado, usarlo (más confiable)
    if (proxyUrl != null && proxyUrl!.isNotEmpty) {
      return _trackViaProxy(cleanTrackingNumber);
    }
    
    // Si no, usar petición directa
